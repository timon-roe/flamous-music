...
var Page = function Page(_ref3) {
  var id = _ref3.pageNumber,
      addPage = _ref3.addPage,
      removePage = _ref3.removePage;
  return (0, _hyperapp.h)('div', { class: 'page-container' }, [(0, _hyperapp.h)('h1', {}, 'pageNumber'), (0, _hyperapp.h)('button', { onclick: addPage }, '+ Add Page'), (0, _hyperapp.h)('button', { onclick: removePage }, '- Remove Page')]);
};

var view = function view(_ref4, _ref5) {
  var pages = _ref4.pages;
  var addPage = _ref5.addPage,
      removePage = _ref5.removePage;
  return (0, _hyperapp.h)('div', {}, [(0, _hyperapp.h)('h1', {}, 'Lowest level'), (0, _hyperapp.h)('button', { onclick: addPage }, '+ Add Page'),
  // console.log(state)
  pages.map(function (_ref6) {
    var id = _ref6.id;
    return Page({ id: id, addPage: addPage, removePage: removePage });
  })]);
};

(0, _hyperapp.app)(state, actions, view, document.body);
},{"hyperapp":6}],8:[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '38677' + '/');
...
//# sourceMappingURL=/flamous-music.7fd82415.map