...
parcelRequire = function (modules, cache, entry, globalName) {
  ...
  // Override the current require with this new one
  return newRequire;
}(_defineProperty2({ 15: [function (require, module, exports) {
    "use strict";
    ...
    (function webpackUniversalModuleDefinition(root, factory) {
      if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object' && (typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object') module.exports = factory();else if (typeof define === 'function' && define.amd) define("Amplitude", [], factory);else if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) === 'object') exports["Amplitude"] = factory();else root["Amplitude"] = factory();
    })(this, function () {
    ...
    ***************************************************************************** */
    ...
    var contains = function contains(term) {
      return function (v) {
        return typeof v === 'string' && v.indexOf(term) !== -1;
      };
    };
    var isFirstChars = function isFirstChars(term) {
      return function (v) {
    ...
    var splitCommaDelimited = function splitCommaDelimited(value) {
    ...
    var alpha = _assign({}, number, { transform: clamp(0, 1) });
    var scale = _assign({}, number, { default: 1 });
    ...
    var rgbUnit = _assign({}, number, { transform: function transform(v) {
    ...
    var hex = _assign({}, rgba, { test: isFirstChars('#'), parse: function parse(v) {
        var r = '';
        var g = '';
        var b = '';
        if (v.length > 4) {
    ...
    var createStyler = function createStyler(_a) {
      ...
      return function (props) {
        ...
        var setValue = function setValue(unmappedKey, value) {
    ...
    var isTransformProp = function isTransformProp(key) {
    ...
    var styleRule = function styleRule(key, value) {
    ...
    function buildStylePropertyString(state, changedValues, enableHardwareAcceleration, blacklist) {
      ...
      for (var i = 0; i < totalNumChangedValues; i++) {
        ...
        if (valueType && ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === NUMBER || (typeof value === 'undefined' ? 'undefined' : _typeof(value)) === OBJECT) && valueType.transform) {
    ...
    var cssStyler = /*#__PURE__*/createStyler({
      ...
      onRender: function onRender(state, _a, changedValues) {
        var element = _a.element,
    ...
    var percentToPixels = function percentToPixels(percent$$1, length) {
  ...
  }, { "framesync": 82, "style-value-types": 80, "tslib": 78, "hey-listen": 79 }], 29: [function (require, module, exports) {
    'use strict';
    ...
    var dilate = function dilate(a, b, dilation) {
    ...
    var pointFromAngleAndDistance = function pointFromAngleAndDistance(origin, angle, distance) {
    ...
    var smooth = function smooth(newValue, oldValue, duration, smoothing) {
      if (smoothing === void 0) {
        smoothing = 0;
      }
      return toDecimal(oldValue + duration * (newValue - oldValue) / Math.max(smoothing, duration));
    };
    var speedPerFrame = function speedPerFrame(xps, frameDuration) {
      return isNum(xps) ? xps / (1000 / frameDuration) : 0;
    };
    var speedPerSecond = function speedPerSecond(velocity, frameDuration) {
    ...
    var applyOffset = function applyOffset(from, to) {
      ...
      var applyOffsetTo = function applyOffsetTo(v) {
        return v + to;
      };
      return function (v) {
        if (hasReceivedFrom) {
    ...
    var blendColor = function blendColor(from, to) {
    ...
    var blendArray = function blendArray(from, to) {
    ...
    var slowInterpolate = function slowInterpolate(input, output, rangeLength, rangeEasing) {
    ...
    var fastInterpolate = function fastInterpolate(minA, maxA, minB, maxB) {
      return function (v) {
    ...
    var generateStaticSpring = function generateStaticSpring(alterDisplacement) {
    ...
    var smooth$1 = function smooth$1(strength) {
      if (strength === void 0) {
        strength = 50;
      }
      var previousValue = 0;
    ...
    var isSingleValue = function isSingleValue(v) {
      var typeOfV = typeof v === 'undefined' ? 'undefined' : _typeof(v);
    ...
    var value = function value(_value, initialSubscription) {
      return new ValueReaction({ value: _value, initialSubscription: initialSubscription });
    };
            ...
            return a.start({
              complete: function complete() {
                if (!hasCompleted) {
                  hasCompleted = true;
                  numCompletedActions++;
                  if (numCompletedActions === numActions) (0, _framesync.onFrameUpdate)(_complete);
                }
              },
              error: error,
    ...
    var createColorAction = function createColorAction(action, _a) {
      var from = _a.from,
          to = _a.to,
          props = (0, _tslib.__rest)(_a, ["from", "to"]);
      return action((0, _tslib.__assign)({}, props, { from: 0, to: 1 })).pipe(blendColor(from, to), _styleValueTypes.color.transform);
    };
    var createComplexAction = function createComplexAction(action, _a) {
      var from = _a.from,
          to = _a.to,
          props = (0, _tslib.__rest)(_a, ["from", "to"]);
    ...
    var createReversedEasing = function createReversedEasing(easing) {
      return function (p) {
        return 1 - easing(1 - p);
      };
    };
    var createMirroredEasing = function createMirroredEasing(easing) {
      return function (p) {
    ...
    var crossfade = function crossfade(a, b) {
      return action(function (observer) {
        var balance = 0;
        var fadable = parallel$1(a, b).start((0, _tslib.__assign)({}, observer, { update: function update(_a) {
            var va = _a[0],
                vb = _a[1];
  ...
  }, { "tslib": 78, "framesync": 82, "style-value-types": 80, "hey-listen": 79, "stylefire": 81 }], 30: [function (require, module, exports) {
    "use strict";
    ...
    exports.blendArray = function (from, to) {
      ...
      var blendValue = from.map(function (fromThis, i) {
        var toThis = to[i];
        return typeof fromThis === 'number' ? function (v) {
          return calc_1.getValueFromProgress(fromThis, toThis, v);
  ...
  }, { "framesync": 82, "style-value-types": 80, "./calc": 30 }], 7: [function (require, module, exports) {
    'use strict';
    ...
    var ScrubBar = function ScrubBar(props) {
      return (0, _hyperapp.h)(Wrapper, null, (0, _hyperapp.h)(Bubble, { playingState: props.playingState, oncreate: function (props) {
          return function (element) {
            return makeInteractive(element, props);
          };
        }(props) }, (0, _hyperapp.h)(Indicator, null), (0, _hyperapp.h)(SongCover, { draggable: 'false', src: props.image }), (0, _hyperapp.h)(Info, null, (0, _hyperapp.h)(Song, null, props.playingState ? '► ' : '', props.name), (0, _hyperapp.h)(Artist, null, props.artist))));
    };

    exports.default = ScrubBar;
  }, { "hyperapp": 15, "picostyle": 17, "popmotion": 29, "popmotion/lib/transformers": 33, "popmotion/lib/calc": 30 }], 35: [function (require, module, exports) {
    module.exports = "dist/placeholder.7de1884c.jpg";
    ...
    var Header = function Header() {
      ...
      })({}, [(0, _hyperapp.h)('h1', null, 'Flamous'), (0, _hyperapp.h)('p', { 'class': 'sub' }, 'The best of Public Domain music.')]);
    };
    ...
    var Gallery = function Gallery(props) {
      return style('div')({
        ...
        boxSizing: 'border-box',
        marginBottom: '6em'
      })({}, (0, _hyperapp.h)(FlexWrapper, null, props.data.map(function (item) {
    ...
    var Item = function Item(props) {
      ...
      })({}, [(0, _hyperapp.h)(Cover, { src: props.image }), (0, _hyperapp.h)('p', null, props.name), (0, _hyperapp.h)('p', { 'class': 'secondary' }, 'by ', props.artist)]);
    };
    ...
    var Home = function Home() {
      return (0, _hyperapp.h)(Page, null, (0, _hyperapp.h)(Header, null), (0, _hyperapp.h)(Gallery, { data: _albums2.default }));
    };

    exports.default = Home;
  }, { "hyperapp": 15, "picostyle": 17, "../albums.js": 27 }], 37: [function (require, module, exports) {
    module.exports = "dist/0.0abd2334.jpg";
  }, {}], 38: [function (require, module, exports) {
    module.exports = "dist/1.21199a7a.jpg";
  }, {}], 39: [function (require, module, exports) {
    module.exports = "dist/2.4aabedd5.jpg";
  }, {}], 40: [function (require, module, exports) {
    module.exports = "dist/3.5d94764e.jpg";
  }, {}], 41: [function (require, module, exports) {
    module.exports = "dist/4.81d24bb5.jpg";
  }, {}], 42: [function (require, module, exports) {
    module.exports = "dist/5.afbcc001.jpg";
  }, {}], 43: [function (require, module, exports) {
    module.exports = "dist/6.39e6b3a8.jpg";
  }, {}], 44: [function (require, module, exports) {
    module.exports = "dist/7.9c63c940.jpg";
  ...
  }, { "./0.jpg": 37, "./1.jpg": 38, "./2.jpg": 39, "./3.jpg": 40, "./4.jpg": 41, "./5.jpg": 42, "./6.jpg": 43, "./7.jpg": 44 }], 45: [function (require, module, exports) {
    module.exports = "dist/0.ca5c42b4.mp3";
  }, {}], 46: [function (require, module, exports) {
    module.exports = "dist/1.de706ed2.mp3";
  }, {}], 47: [function (require, module, exports) {
    module.exports = "dist/2.765be34b.mp3";
  }, {}], 48: [function (require, module, exports) {
    module.exports = "dist/3.186c9339.mp3";
  }, {}], 49: [function (require, module, exports) {
    module.exports = "dist/4.db0b0919.mp3";
  }, {}], 50: [function (require, module, exports) {
    module.exports = "dist/5.3df0ff33.mp3";
  }, {}], 51: [function (require, module, exports) {
    module.exports = "dist/6.c7c83925.mp3";
  }, {}], 52: [function (require, module, exports) {
    module.exports = "dist/7.91917103.mp3";
  ...
  }, { "./0.mp3": 45, "./1.mp3": 46, "./2.mp3": 47, "./3.mp3": 48, "./4.mp3": 49, "./5.mp3": 50, "./6.mp3": 51, "./7.mp3": 52 }], 6: [function (require, module, exports) {
    'use strict';
  ...
  }, { "./public/128/*.jpg": 13, "./public/songs/*.mp3": 14 }], 9: [function (require, module, exports) {
    module.exports = "dist/song_placeholder.8d83acaa.svg";
    ...
    var flamous = (0, _hyperapp.app)({
      ...
      return (0, _hyperapp.h)(AppShell, null, (0, _hyperapp.h)(_Home2.default, null), (0, _hyperapp.h)(_ScrubBar2.default, {
  ...
  }, { "hyperapp": 15, "amplitudejs": 16, "picostyle": 17, "./components/ScrubBar.js": 7, "./components/Home.js": 8, "./songs.js": 6, "./public/song_placeholder.svg": 9 }] }, '41', [function (require, module, exports) {
  var global = arguments[3];
...
//# sourceMappingURL=dist/src.4631146b.map
},{}],4:[function(require,module,exports) {
var global = arguments[3];
var OVERLAY_ID = '__parcel__error__overlay__';
...
//# sourceMappingURL=/src.4631146b.8b4c7aa0.map